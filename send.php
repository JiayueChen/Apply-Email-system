...
<body>
	<div class="container">
		<div class="jumbotron">
			<h1 class="display-4">Let's send a template</h1>
			<p class="lead">This is a Resful Application to get all email templates and send from back-end server by Ajax and Json</p>
			<hr class="my-4">
			...
			function(data) {
				$.each(data,function(key, value) {
					...
					<div>
						...
						<input id="rcpt` + tid + `"class="rcpt form-control" type="text"></input>
